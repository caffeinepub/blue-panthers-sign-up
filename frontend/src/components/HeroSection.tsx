                ...
                <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-16 lg:px-24">
                    <div className="max-w-2xl animate-fade-in-up">
                        ...
                        <p className="font-body text-base text-foreground/60 max-w-md leading-relaxed">
                            The 2026 season has officially started. Roster registration is now closed.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
                        <div className="flex items-center gap-2">
                            <span className="font-display text-xl font-black text-gold-400 leading-none">2026</span>
                            <span className="font-body text-xs font-semibold text-foreground/50 uppercase tracking-widest">Season</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="font-display text-xl font-black text-gold-400 leading-none">League.maine</span>
                            <span className="font-body text-xs font-semibold text-foreground/50 uppercase tracking-widest">League</span>
                        </div>
