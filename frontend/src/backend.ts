...
import type { ExperienceLevel as _ExperienceLevel, Position as _Position, SignUp as _SignUp, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getSignUpById(arg0: bigint): Promise<SignUp> {
        if (this.processError) {
            try {
                const result = await this.actor.getSignUpById(arg0);
                return from_candid_SignUp_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitSignUp(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Position, arg5: ExperienceLevel): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSignUp(arg0, arg1, arg2, arg3, to_candid_Position_n13(this._uploadFile, this._downloadFile, arg4), to_candid_ExperienceLevel_n15(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_SignUp_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SignUp): SignUp {
...
function to_candid_ExperienceLevel_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ExperienceLevel): _ExperienceLevel {
